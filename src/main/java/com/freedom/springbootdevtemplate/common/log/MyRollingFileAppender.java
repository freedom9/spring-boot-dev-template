 ...
 */
@Slf4j
@Plugin(name = MyRollingFileAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public class MyRollingFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {

    public static final String PLUGIN_NAME = "MyRollingFile";
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<MyRollingFileAppender> {
        ...
        @Override
        public MyRollingFileAppender build() {
            ...
            if (getName() == null) {
                LOGGER.error("MyRollingFileAppender '{}': No name provided.", getName());
                return null;
            }

            if (!isBufferedIo && bufferSize > 0) {
                LOGGER.warn("MyRollingFileAppender '{}': The bufferSize is set to {} but bufferedIO is not true", getName(), bufferSize);
            }

            if (filePattern == null) {
                LOGGER.error("MyRollingFileAppender '{}': No file name pattern provided.", getName());
                return null;
            }

            if (policy == null) {
                LOGGER.error("MyRollingFileAppender '{}': No TriggeringPolicy provided.", getName());
                return null;
            }
            ...
            if (strategy == null) {
                ...
                LOGGER.error("MyRollingFileAppender '{}': When no file name is provided a DirectFilenameRolloverStrategy must be configured");
                return null;
            }
            ...
            return new MyRollingFileAppender(getName(), layout, getFilter(), manager, fileName, filePattern,
    ...
    /**
     * Creates a MyRollingFileAppender.
     ...
     * @return A MyRollingFileAppender.
     * @deprecated Use {@link #newBuilder()}.
     */
    @Deprecated
    public static <B extends Builder<B>> MyRollingFileAppender createAppender(
            // @formatter:off
        ...
        // @formatter:off
        return MyRollingFileAppender.<B>newBuilder()
